...
const SchoolsHeroSectionOptionC = ({ videoId, openCalendly, showForm }) => {
  ...
  return (
    <HeroContainer>
      ...
      <Display1 className="heading">
        {t.translate("directus.page_schoolleader_2024.hero_title_option1")}
      </Display1>
      <Headline3 className="text" css={{ color: "#5D5D8F" }}>
        {t.translate("directus.page_schoolleader_2024.hero_subtitle_option")}
      </Headline3>
      <PlayVideoContainer className="video-container">
        {showVideo ? (
          <iframe
            width="100%"
            src={`https://www.youtube-nocookie.com/embed/ifOt8Pjs93g?autoplay=1`}
          ...
          <>
            ...
            <img
              src={`https://img.youtube.com/vi/ifOt8Pjs93g/maxresdefault.jpg`}
              css={{ borderRadius: 46 }}
              alt=""
            />
          </>
      ...
      {showForm ? (
        ...
        <CTAContainer className="cta">
          ...
          <BlackButtonLink
            kind="tertiary"
            onClick={() => openCalendly("experiment_var3")}
          >
            {t.translate(
      ...
      >
        <Typography variant="Headline2ExtraBold" css={{ color: "#8047FF" }}>
          {t.translate(
            "directus.page_schoolleader_2024.sentence_free_for_schools"
          )}
        </Typography>
      </Display3>
    </HeroContainer>
...
export default SchoolsHeroSectionOptionC;
