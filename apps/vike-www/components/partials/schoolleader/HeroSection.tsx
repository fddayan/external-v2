...
const SchoolsHeroSection = ({ videoId, openCalendly, showForm }) => {
  ...
  return (
    <HeroContainer>
      <RiveComponent
        ...
        className="rive"
        css={{ width: 300, height: 200, marginInline: "auto", marginTop: 30 }}
      />
      ...
      {showForm ? (
        ...
        <CTAContainer className="cta">
          <BlackButton onClick={() => openCalendly("test_hero")}>
            {t.translate("directus.page_schoolleader_2024.primary_cta_copy")}
          </BlackButton>
          <BlackButtonLink kind="tertiary" onClick={openSignupModal}>
            {t.translate("directus.page_schoolleader_2024.secondary_cta_copy")}
          </BlackButtonLink>
        </CTAContainer>
      )}
