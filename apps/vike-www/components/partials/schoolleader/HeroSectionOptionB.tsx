...
const SchoolsHeroSectionOptionB = ({ videoId, openCalendly, showForm }) => {
    ...
    <HeroContainer>
      ...
      {showForm ? (
        ...
        <CTAContainer className="cta">
          ...
          <BlackButtonLink
            kind="tertiary"
            onClick={() => openCalendly("experiment_var2")}
          >
            {t.translate(
...
export default SchoolsHeroSectionOptionB;
