...
const HeroSection = () => {
  ...
  return (
    <HeroSectionStyled>
      <Container>
        <InfoBoxTitle>
          <Translate path="directus.page_teacherlp3.hero_title" />
        </InfoBoxTitle>
        <Box textAlign="center" margin="auto" maxWidth="600px">
          <Subtitle>
            <Translate path="directus.page_teacherlp3.hero_subtitle" />
          </Subtitle>
          <Button kind="secondary" onClick={() => openSignupModal()} width="100%">
            <Translate path="directus.page_landing_common_data.hero_button_text" />
          </Button>
          <Disclaimer>
            <span aria-hidden={true}>⭐</span> <Translate path="directus.page_teacherlp3.hero_text" />{" "}
